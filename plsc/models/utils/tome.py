...
class ToMeBlock(Block):
    ...
    def forward(self, x: paddle.Tensor) -> paddle.Tensor:
        # Note: this is copied from plsc.models.vision_transformer.Block with modifications.
...
class ToMeAttention(Attention):
    ...
    def forward(
        ...
        # Note: this is copied from plsc.models.vision_transformer.Attention with modifications.
        N, C = x.shape[1:]
