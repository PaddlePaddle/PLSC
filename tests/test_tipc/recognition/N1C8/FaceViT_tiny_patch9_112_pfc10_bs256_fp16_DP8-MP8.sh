...
model_item=FaceViT_tiny_patch9_112_pfc10
fp_item=fp16
bs_item=256
run_mode=DP8-MP8
device_num=N1C8
yaml_path=./task/recognition/face/configs/FaceViT_tiny_patch9_112_WebFace42M_CosFace_pfc10_droppath005_mask0_1n8c_dp_mp_fp16o1.yaml \
max_iter=7589 # epoch=3
sample_ratio=1.0
model_parallel=True
